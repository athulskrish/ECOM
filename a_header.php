    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="#"><img src="admin/img/ui-sam.jpg" class="img-circle" width="80"></a></p>
         ...
         <!--  <li class="sub-menu">
          ...
          <li class="sub-menu">
            <a href="admin_gstnumber.php">
              <i class="fa fa-book"></i>
              <span>GST number registration</span>
              </a>
